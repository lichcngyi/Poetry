...
using Poetry.MultiTenancy;
using Poetry.Web.Menus;
    ...
    public class PoetryWebModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<PoetryDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Poetry.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<PoetryDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Poetry.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<PoetryApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Poetry.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<PoetryApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Poetry.Application"));
