...
{
    public partial class Name52 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MyId = table.Column<string>(type: "nvarchar(20)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MyId = table.Column<string>(type: "nvarchar(20)", nullable: true),
                    RelatedTranslation = table.Column<string>(type: "nvarchar(max)", nullable: true),
